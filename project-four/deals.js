		...
		var requestURL = 'https://vinirocks82.github.io/project-four/products.json';
      ...
      console.log(Deals); 
		...
		function topDeals(jsonObj){
			...
			for (var i = 0; i < topDeals.length; i++) {
				...
				img.setAttribute('src', 'https://vinirocks82.github.io/project-four/products.json' + topDeals[i].image);
